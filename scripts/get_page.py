#!/usr/bin/env python3
"""
Fetch a single page by its `id` (deterministic lookup).

Usage:
    python3 scripts/get_page.py hw-cube-unit
    python3 scripts/get_page.py pr-sgl-kernel-npu-001
    python3 scripts/get_page.py hw-unified-buffer --frontmatter
    python3 scripts/get_page.py hw-unified-buffer --field sources
    python3 scripts/get_page.py cube                         # fuzzy: suggest ids
"""
