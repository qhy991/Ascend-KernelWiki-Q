...
### `csrc/attention/fused_gdn_gating/fused_gdn_gating_torch_adpt.h`
```cpp
/*
...
### `csrc/attention/fused_gdn_gating/op_host/fused_gdn_gating_tiling_utils.h`
```cpp
/**
 * Copyright (c) 2026 Huawei Technologies Co., Ltd.
 * SPDX-License-Identifier: Apache-2.0
...
### `csrc/attention/fused_gdn_gating/op_host/fused_gdn_gating_def.cpp`
```cpp
/**
 * Copyright (c) 2026 Huawei Technologies Co., Ltd.
 * SPDX-License-Identifier: Apache-2.0
